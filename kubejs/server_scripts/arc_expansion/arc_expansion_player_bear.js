...
const dlcTemplateOrganPlayerBearStrategies = {
	// 示例器官-受伤
	"arc_expansion:example_organ_bear": function (event, organ, data) {
		// 获取玩家
...
var assign_organ_player_bear = Object.assign(
	organPlayerBearStrategies,
	dlcTemplateOrganPlayerBearStrategies,
);
...
const dlcTemplateOrganPlayerBearOnlyStrategies = {
	// 示例器官-唯一受伤
	"arc_expansion:example_organ_bear_only": function (event, organ, data) {
		// 获取玩家
		let player = event.entity;
		// 获取攻击者
...
var assign_organ_player_bear_only = Object.assign(
	organPlayerBearOnlyStrategies,
	dlcTemplateOrganPlayerBearOnlyStrategies,
);
