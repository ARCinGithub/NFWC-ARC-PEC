...
const dlcTemplateOrganRightClickedStrategies = {
	// 示例器官-右键点击
	"arc_expansion:example_organ_rclick": function (event, organ) {
		// 获取物品
		let item = event.item;
		// 获取玩家
...
var assign_organ_right_clicked = Object.assign(
	organRightClickedStrategies,
	dlcTemplateOrganRightClickedStrategies,
);
...
const dlcTemplateOrganRightClickedOnlyStrategies = {
	// 示例器官-唯一右键点击
	"arc_expansion:example_organ_rclick_only": function (event, organ) {
		// 获取物品
		let item = event.item;
		// 获取玩家
		let player = event.player;
...
var assign_organ_right_clicked_only = Object.assign(
	organRightClickedOnlyStrategies,
	dlcTemplateOrganRightClickedOnlyStrategies,
);
