...
const dlcTemplateOrganBlockBrokenStrategies = {
  // 示例器官-破坏
  "arc_expansion:example_organ_break": function (event, organ) {
    // 获取玩家
...
var assign_organ_food_eaten = Object.assign(
  organBlockBrokenStrategies,
  dlcTemplateOrganBlockBrokenStrategies
);
...
const dlcTemplateOrganBlockBrokenOnlyStrategies = {
  // 示例器官-唯一破坏
  "arc_expansion:example_organ_break_only": function (event, organ) {
    // 获取玩家
    let player = event.player;
    // 初始化计数
    let count = 1;
...
var assign_organ_food_eaten_only = Object.assign(
  organBlockBrokenOnlyStrategies,
  dlcTemplateOrganBlockBrokenOnlyStrategies
);
