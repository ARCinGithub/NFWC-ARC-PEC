...
const dlcTemplateOrganPlayerEnchantStrategies = {
  // 示例器官-附魔
  "arc_expansion:example_organ_enchant": function (event, organ) {
    // 遍历附魔槽位
...
var assign_enchant = Object.assign(
  organPlayerEnchantStrategies,
  dlcTemplateOrganPlayerEnchantStrategies
);
...
const dlcTemplateOrganPlayerEnchantOnlyStrategies = {
  // 示例器官-唯一附魔
  "arc_expansion:example_organ_enchant_only": function (event, organ) {
    // 遍历附魔槽位
    slotList.forEach((slot) => {
      // 获取附魔槽位
      let enchantSlot = event.get(slot);
...
var assign_enchant_only = Object.assign(
  organPlayerEnchantOnlyStrategies,
  dlcTemplateOrganPlayerEnchantOnlyStrategies
);
